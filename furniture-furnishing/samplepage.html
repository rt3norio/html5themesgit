...
<html>
<head>
	<title>Furnishing a Furniture Category Flat bootstrap Responsive website Template | Sample page :: w3layouts</title>
		...
		<div class="container">
			<div class="col-md-9 top-nav">
				...
				<ul class="nav1">
					...
					<li><a href="samplepage.html" class="active">SAMPLE PAGE</a></li>
		...
		<div class="container">
			...
			<div class="col-md-8 sample-page-left" >
				...
				<div class="sample-page-info">
					<a href="samplepage.html"> <img src="images/sample.jpg" class="img-responsive zoom-img" alt=""/></a>
			...
			<div class="col-md-4 sample-page-right">
				<div class="category">
					<h4>CATEGORIES</h4>
					<ul>
						<li><a href="samplepage.html">Donec ut quam ligula feugiat scelerisque.</a></li>
						<li><a href="samplepage.html">Etiam volutpat tortor quis nibh lobortis</a></li>
						<li><a href="samplepage.html">Fusce vitae dolor vitae blandit varius.</a></li>
						<li><a href="samplepage.html">Proin commodo metus sed nisi lobortis.</a></li>
						<li><a href="samplepage.html">Nunc volutpat neque vel augue interdum,</a></li>
						<li><a href="samplepage.html">condimentum fringilla justo lobortis.</a></li>
						<li><a href="samplepage.html">Vivamus consequat dolor ac est congue.</a></li>
					</ul>
				</div>	
				<div class="recent-posts">
					...
					<div class="recent-posts-info">
						<div class="posts-left">
							<a href="samplepage.html"> <img src="images/recent-1.jpg" class="img-responsive zoom-img" alt=""/> </a>
						</div>
						<div class="posts-right">
							<lable>MARCH 5, 2015</lable>
							<h5> <a href="samplepage.html">FRINGILLA CONDIMENTUM </a></h5>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing incididunt.</p>
							<div class="read-more">
								<a href="samplepage.html">Read More</a>
							</div>
						</div>
						<div class="clearfix"> </div>
					</div>	
					<div class="recent-posts-info">
						<div class="posts-left">
							<a href="samplepage.html"> <img src="images/recent-2.jpg" class="img-responsive zoom-img" alt=""/></a>
						</div>
						<div class="posts-right">
							<lable>MARCH 1, 2015</lable>
							<h5><a href="samplepage.html">FINIBUS BONORUM MALORUM </a></h5>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing incididunt.</p>
							<div class="read-more">
								<a href="samplepage.html">Read More</a>
							</div>
	...
	<div class="footer">
		<div class="container">
			<div class="footer-right">
				<p>© 2015 All rights reserved | Template by <a href="http://w3layouts.com/" target="_blank"> W3layouts</a></p>
			</div>
		</div>	
	</div>
