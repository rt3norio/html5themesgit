...
elseif ($page_name=='womens.html') {
	include $browser_t.'/womens.html';
	}
elseif ($page_name=='mens.html') {
	include $browser_t.'/mens.html';
	}
elseif ($page_name=='other.html') {
	include $browser_t.'/other.html';
	}
